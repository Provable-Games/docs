...
export function HomePage() {
  return (
    <div className="">
      <div className="border-y border-white/20 py-8 border-[#252525] bg-[#1e1e1e]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 flex flex-col sm:flex-row gap-8 sm:gap-20">
          ...
          <div className="sm:w-3/4 flex items-center">
            <h1 className="text-3xl sm:text-4xl">
              A Web3 game studio specializing in games and autonomous worlds
              that can be cryptographically verified using zero-knowledge
              proofs.
            </h1>
          </div>
        </div>
