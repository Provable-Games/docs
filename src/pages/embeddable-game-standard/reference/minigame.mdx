...
- Game ID (assigned by registry during registration)
...
self.minigame.initializer(
    ...
    settings_address,       // Option<ContractAddress> - settings component
    objectives_address,     // Option<ContractAddress> - objectives component
