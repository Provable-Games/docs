...
```cairo
fn minted_by(self: @TState, token_id: felt252) -> u64;
fn minted_by_batch(self: @TState, token_ids: Span<felt252>) -> Array<u64>;
```
...
The token contract uses compile-time feature flags to control which extensions are included. This reduces contract size by eliminating dead code.

See [Feature Flags](/embeddable-game-standard/advanced/feature-flags) for details.
