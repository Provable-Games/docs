...
**How It Works:**
- Potions are streamed block-by-block into an [Ekubo](https://ekubo.org/) liquidity pool
...
- **There is no advantage to buying early.** The auction is designed to find fair market price through continuous supply
