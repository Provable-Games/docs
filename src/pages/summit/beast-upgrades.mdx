...
- **Kill Tokens** - Earned when your beasts kill adventurers (1 per kill). Used to increase attributes or unlock abilities
...
**Cost:** 1 $Kill per level (up to 255)
...
- Additional 4-hour reduction if your beast hasn't been killed in Loot Survivor for 2+ weeks

**Revival Time Calculation:**
- Base: 24 hours
- With Maximum Spirit: Reduced by 18.5 hours
- Survivor bonus: -4 hours (if not killed in Loot Survivor in 14 days)
- Minimum possible: 1.5 hours (with all reductions)
...
```
Damage Boost = (Total Power of all Diplomacy beasts / 500) × 10%
```

**Example:** 
- Your "Agony Bane" beast (Power 200) has Diplomacy
- Two other "Agony Bane" beasts (Power 150 each) also have Diplomacy
- Total Power = 200 + 150 + 150 = 500
- Summit holder gets: (500 / 500) × 10% = 10% damage boost
...
- **1 Kill Token** per adventurer killed
