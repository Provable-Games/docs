...
4. **Earn Rewards** - Receive 0.01 $SURVIVOR for every second you hold the Summit
...
Summit will distribute a total of **TBD $SURVIVOR** tokens:
- **~0.01 $SURVIVOR** per second to the Summit holder (and matching name beasts with diplomacy unlocked)
- Game ends after a fixed amount of time
- Current planned duration is 2 months
...
5. **Complete Quests** - Complete objectives for your beasts to earn $SURVIVOR
