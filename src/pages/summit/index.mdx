...
4. **Earn Rewards** - Receive 0.02 $SURVIVOR for every second you hold the Summit (0.1 per block)

### What You Need to Play

- **Beast NFTs**
  - Collect them by playing [Loot Survivor](https://lootsurvivor.io/)
  - Purchase on marketplace: [Realms Marketplace](https://empire.realms.world/trade/beasts)
...
Ready to conquer the Summit? Learn about the [Battle System](/summit/battle-system) to understand combat mechanics.