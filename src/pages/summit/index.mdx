...
<a
  href="https://summit.game/"
  target="_blank"
  rel="noreferrer"
  style={{ display: "block", margin: "16px 0", textDecoration: "none" }}
>
  <div
    style={{
  ...
  >
    ...
    <div
      style={{
        ...
        gap: 12,
        padding: "10px 12px",
        background: "rgba(70,169,240,0.10)",
        color: "rgba(255,255,255,0.92)",
      }}
    >
      <strong style={{ fontSize: 14, lineHeight: "18px" }}>Play Summit</strong>
      <span style={{ fontSize: 13, opacity: 0.9 }}>Open https://summit.game/ -></span>
    </div>
  </div>
</a>
