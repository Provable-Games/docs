...
3. **First Beast Advantage** - Only the first beast will benefit from attack potions
4. **Strategic Order** - Choose your beast order wisely
...
- Beasts can have up to 255 extra lives
...
3. **Load Attack Potions** - Only on your first beast
...
1. **Maximize Health** - Feed $CORPSE tokens for bonus health (up to 1,023)
