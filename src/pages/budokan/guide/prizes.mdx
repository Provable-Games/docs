...
<div className="flex flex-row gap-4 items-start">
  <div className="flex-1">
    <p>
      Budokan supports any ERC20 token listed on the Ekubo API as a prize, plus a curated set of ERC721 (NFT) collections. The token picker is sourced from Ekubo's listings, with USD pricing pulled from Ekubo at runtime. This lets communities and sponsors contribute a wide variety of rewards.
    </p>
  </div>
...
## Building on PrizeComponent

Budokan's prize system is powered by the `PrizeComponent` from the open-source [game-components](https://github.com/Provable-Games/game-components) library. This component handles ERC20/ERC721 deposits, position-based distribution, and claim tracking. If you're building your own competition platform, you can reuse or extend this component with custom prize logic — for example, adding new token types, custom distribution curves, or time-locked prizes. See [Component Architecture](/budokan/key-functions#component-architecture) for details.
