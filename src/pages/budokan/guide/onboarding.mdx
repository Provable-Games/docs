...
2. Choose your preferred login method. The Cartridge Controller supports a range of social, wallet, and passkey logins — see the [Cartridge Controller docs](https://docs.cartridge.gg/controller/overview) for the current list.
