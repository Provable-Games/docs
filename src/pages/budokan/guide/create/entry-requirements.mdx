...
These validators ship as presets in the [`metagame-extensions`](https://github.com/Provable-Games/metagame-extensions) `presets/` package. For the underlying component model, see the [Metagame Extensions reference](/embeddable-game-standard/reference/metagame-extensions) in the EGS docs.
