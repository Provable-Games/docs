...
- **Game Fee:**
  - The percentage of each entry fee that goes to the game developer. A default game fee of 5% is enforced via the [Embeddable Game Standard](/embeddable-game-standard/architecture). The game developer receives this cut via the account holding `Game #0`.
