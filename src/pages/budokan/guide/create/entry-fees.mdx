...
<div className="flex flex-row">
   <p>
      Budokan supports any ERC20 token listed on the Ekubo API for tournament entry fees. The token picker is sourced from Ekubo's listings, with USD pricing pulled from Ekubo at runtime. ERC721 (NFT) entry fees are not yet supported.
   </p>
...
Budokan's entry fee system is powered by the `EntryFeeComponent` from the open-source [game-components](https://github.com/Provable-Games/game-components) library. This component handles fee collection, share splitting, and payouts. If you're building your own competition platform, you can reuse or extend this component with custom distribution logic. See [Component Architecture](/budokan/key-functions#component-architecture) for details.
