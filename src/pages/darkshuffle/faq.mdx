...
Yes! You can start and play games for free. Some tournaments or special events may have entry requirements.
...
There is a link to Budokan tournaments on the home page, see the [Enter Tournaments](/budokan/guide/enter) section on how to enter.

**Are there prizes?**

Yes! Many tournaments offer prizes for top players. Details are listed in each event.
