...
<p style={{ marginBottom: "1.2rem", fontWeight: "400" }}>
  The loot system in Loot Survivor is inspired by the original{" "}
  <a href="https://docs.loot.foundation/" style={{ color: "#3b82f6" }}>
    Loot collection
  </a>{" "}
  and forms the backbone of your adventurer's power progression.
</p>
