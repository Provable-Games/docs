...
- **Level Scaling**: Beast level is randomly derived when you encounter it, based on your adventurer's current level. Higher adventurer levels can produce higher level beasts
- **Beast Power**: Calculated as `Beast Level × (6 - Beast Tier)` — a high-level T1 beast is the strongest possible encounter
...
> **Summit:** Beasts can gain up to 40 bonus levels through XP earned in [Summit](/summit) combat, making them even more powerful. See [Beast Upgrades](/summit/beast-upgrades) for details.
