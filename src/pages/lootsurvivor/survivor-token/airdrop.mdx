...
- **1 Token per Level**: Starting at level 3, earn 1 token for each level
...
- Level 3: 1 token
- Level 10: 8 tokens (levels 3-10)
- Level 25: 23 tokens (levels 3-25)
...
- **Level 3+**: Earn 1 token per level starting from level 3
