...
| ├─ LS2 Dungeon | 2,258,100 | 22.58% | Gameplay rewards (1 token per level from L3) |
...
| ├─ Budokan | 100,000 | 1% | Combat system development |
| └─ Summit | 100,000 | 1% | Achievement systems |
...
- 1 SURVIVOR token per level starting at level 3
- **4X Promotion**: Weeks 2-4 (4 tokens per level)
- **2X Promotion**: After week 4 until all tokens claimed (2 tokens per level)
...
- **LS2 Dungeon**: First-come, first-served through gameplay
  - Week 1: Standard rate (1 token per level from L3)
  - Weeks 2-4: 4X promotion (4 tokens per level)
  - After Week 4: 2X promotion until exhausted
