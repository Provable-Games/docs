...
$SKULL is an ERC20 token on Starknet that represents beast kills in Loot Survivor, created alongside [Summit](/summit). Every time one of your beasts kills an adventurer, you can claim 1 $SKULL. The current only known use case for $SKULL is upgrading beasts in [Summit](/summit/beast-upgrades).
